...
export default function Hero() {
  return (
    <section id="top" className="section pb-24 pt-32 sm:pb-20 sm:pt-32">
      <div className="wrap">
        <div className="panel max-w-2xl px-7 py-9 sm:p-10">
          ...
          <div className="mb-6 mt-8 grid grid-cols-2 gap-3 pr-0 sm:mb-0">
            {STATS.map((stat) => (
              <div key={stat.label} className="rounded-2xl bg-white/80 px-3 py-4 sm:px-4">
          ...
          <div className="flex flex-wrap gap-2 pb-6 sm:pb-0">
            {COUNTRIES.map((country) => (
              <span key={country.code} className="inline-flex items-center gap-1.5 rounded-full bg-white/80 px-2.5 py-1.5 text-xs font-medium text-navy">
